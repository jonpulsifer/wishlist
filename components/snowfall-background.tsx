...
export function SnowfallBackground({ 
  ...
  useEffect(() => {
    ...
    const flakes: Snowflake[] = Array.from({ length: flakeCount }).map((_, i) => ({
      id: i,
  ...
  return (
    <>
      {/* Animated background */}
      {showBackground && (
        <div className={`fixed inset-0 bg-linear-to-br from-slate-200 to-blue-900 dark:from-blue-900 dark:via-slate-900 dark:to-black animate-gradient-shift ${className}`} />
      )}
